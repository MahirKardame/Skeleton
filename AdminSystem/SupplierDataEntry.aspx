...
<body>
    <form id="form1" runat="server">
        <div style="height: 421px; margin-left: 4440px;">
            ...
            <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 187px; top: 333px; position: absolute" Text="Cancel" height="26px" width="60px" />
            ...
            <asp:TextBox ID="txtSupplierId" runat="server" height="22px" style="z-index: 1; left: 149px; top: 23px; position: absolute" width="128px"></asp:TextBox>
            <asp:TextBox ID="txtSupplierName" runat="server" height="22px" style="z-index: 1; left: 149px; top: 66px; position: absolute" width="128px"></asp:TextBox>
            <asp:TextBox ID="txtSupplierEmail" runat="server" height="22px" style="z-index: 1; left: 149px; top: 108px; position: absolute" width="128px"></asp:TextBox>
            <asp:TextBox ID="txtPhoneNumber" runat="server" height="22px" style="z-index: 1; left: 149px; top: 147px; position: absolute" width="128px"></asp:TextBox>
            <asp:TextBox ID="txtAddress" runat="server" height="22px" style="z-index: 1; left: 149px; top: 193px; position: absolute" width="128px"></asp:TextBox>
            <asp:TextBox ID="txtLastOrderDate" runat="server" height="22px" style="z-index: 1; left: 149px; top: 232px; position: absolute" width="128px"></asp:TextBox>
        </div>
    </form>
</body>
</html>
