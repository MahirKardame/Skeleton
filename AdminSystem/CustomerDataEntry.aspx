...
&nbsp;<p>
        ...
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" style="z-index: 1; left: 11px; top: 502px; position: absolute; width: 70px; " Text="OK" />
        <asp:Button ID="btnCancel" runat="server" height="26px" style="z-index: 1; left: 155px; top: 501px; position: absolute; width: 70px" Text="Cancel" />
        <p>
            &nbsp;</p>
    </form>
</body>
