...
<body>
    <form id="form1" runat="server">
        ...
        <asp:CheckBox ID="chkPaid" runat="server" OnCheckedChanged="CheckBox1_CheckedChanged" style="z-index: 1; left: 91px; top: 63px; position: absolute" Text="Paid" />
        <asp:Label ID="lblDatePlaced" runat="server" style="z-index: 1; left: 82px; top: 117px; position: absolute" Text="Date Placed"></asp:Label>
        <asp:Label ID="lblDatePaid" runat="server" style="z-index: 1; left: 86px; top: 171px; position: absolute" Text="Date Paid"></asp:Label>
        ...
        <asp:TextBox ID="txtDatePaid" runat="server" style="z-index: 1; left: 169px; top: 171px; position: absolute"></asp:TextBox>
